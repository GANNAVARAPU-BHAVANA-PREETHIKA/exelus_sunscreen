      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-24">
          ...
          <motion.div 
            ...
            transition={{ duration: 0.8 }}
            className="bg-brand-surface p-12 rounded-[3rem] border border-brand-paper/5"
          >
            <form className="space-y-8">
              ...
              <button className="w-full bg-brand-olive text-brand-ink py-5 rounded-full text-sm uppercase tracking-widest font-bold flex items-center justify-center group hover:bg-white transition-colors">
                Send Message
