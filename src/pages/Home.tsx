  ...
  return (
    <div className="bg-brand-bg">
      ...
      <section className="py-24 max-w-7xl mx-auto px-6 text-center">
        ...
        <h2 className="text-4xl md:text-6xl font-serif mb-16 text-brand-paper">
          Experience the <span className="italic opacity-80">Exelus Glow</span>
        </h2>
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          <div className="group relative aspect-[3/4] overflow-hidden rounded-[150px] bg-brand-beige border border-brand-paper/5">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-12 text-center bg-gradient-to-t from-brand-bg/95 via-brand-bg/50 to-transparent">
              <h3 className="text-3xl font-serif text-brand-paper mb-3">Cleanse</h3>
          ...
          <div className="group relative aspect-[3/4] overflow-hidden rounded-[150px] bg-brand-beige border border-brand-paper/5">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-12 text-center bg-gradient-to-t from-brand-bg/95 via-brand-bg/50 to-transparent">
              <h3 className="text-3xl font-serif text-brand-paper mb-3">Treat</h3>
          ...
          <div className="group relative aspect-[3/4] overflow-hidden rounded-[150px] bg-brand-beige border border-brand-paper/5">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-12 text-center bg-gradient-to-t from-brand-bg/95 via-brand-bg/50 to-transparent">
              <h3 className="text-3xl font-serif text-brand-paper mb-3">Hydrate</h3>
