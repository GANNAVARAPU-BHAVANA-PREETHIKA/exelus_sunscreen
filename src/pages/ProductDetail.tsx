...
export const ProductDetail = () => {
  ...
  return (
    <div className="pt-28 md:pt-32 min-h-screen bg-brand-bg pb-16 md:pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <button 
          onClick={() => navigate(-1)}
          className="flex items-center space-x-2 text-brand-paper/40 hover:text-brand-olive transition-colors mb-8 md:mb-12 group"
        >
        ...
        <div className="grid lg:grid-cols-2 gap-10 md:gap-16 items-start">
          ...
          <motion.div 
            ...
            className="relative aspect-[3/4] rounded-3xl md:rounded-[40px] overflow-hidden bg-brand-surface border border-brand-paper/5"
          >
            <img 
              src={product.image} 
              alt={product.name}
          ...
          >
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif text-brand-paper mb-5 md:mb-6 leading-tight">{product.name}</h1>
              <p className="text-2xl sm:text-3xl font-serif text-brand-olive">₹{product.price.toLocaleString()}</p>
            </div>

            <p className="text-brand-paper/60 text-base md:text-lg leading-relaxed max-w-xl">
              {product.description}
            </p>
            ...
            <div className="flex flex-col space-y-6 pt-4">
              <button 
                ...
                className="w-full max-w-md bg-brand-olive text-brand-ink py-5 md:py-6 rounded-2xl text-xs uppercase tracking-[0.24em] sm:tracking-[0.4em] font-black shadow-2xl shadow-brand-olive/20 hover:bg-white transition-all flex items-center justify-center space-x-4 group"
              >
                <ShoppingBag size={18} className="group-hover:scale-110 transition-transform" />
                <span>Add to Collection</span>
              </button>
              <div className="flex flex-wrap items-center gap-x-6 gap-y-3 md:gap-x-8 text-[10px] uppercase tracking-widest text-brand-paper/30 font-bold">
            ...
            <div className="grid sm:grid-cols-2 gap-8 pt-8 md:pt-10 border-t border-brand-paper/5">
              <div>
        ...
        {/* Reviews Section */}
        <div className="mt-20 md:mt-32 pt-16 md:pt-32 border-t border-brand-paper/5">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 md:mb-16 gap-6">
            <div>
              ...
              <h2 className="text-3xl sm:text-5xl font-serif text-brand-paper">Customer Reviews</h2>
            </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-brand-surface p-6 sm:p-8 rounded-3xl md:rounded-[40px] border border-brand-paper/5 relative group hover:border-brand-olive/20 transition-colors"
              >
